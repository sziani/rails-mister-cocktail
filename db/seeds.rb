...
image_file_serialized = open(url).read
image = JSON.parse(image_file_serialized)
puts "Create Cocktails"

puts image["drinks"][0]["strIngredient1"]
...
# photo = URI.open(userOne["drinks"][0]["strDrinkThumb"])
file = URI.open(userOne["drinks"][0]["strDrinkThumb"])
# puts userOne["drinks"][0]["strDrinkThumb"]
